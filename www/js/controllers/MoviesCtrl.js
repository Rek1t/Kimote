app.controller('MoviesCtrl', ['$scope','$http','$stateParams','$location','$ionicLoading','$sce','Loader', function($scope, $http, $stateParams, $location, $ionicLoading, $sce, Loader) {

	// Get movie label from previous view for display
	$scope.movie_label = $stateParams.movieLabel;

	// Get and display movies list
	// $broadcast stop pull to refresh
