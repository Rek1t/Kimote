app.controller('RemoteCtrl', ['$scope','$http','$stateParams','$location','$ionicPopup','$timeout','Sounder','Manager','Runtime','Requester','Logger', function($scope,$http, $stateParams, $location, $ionicPopup, $timeout, Sounder, Manager, Runtime, Requester, Logger) {
